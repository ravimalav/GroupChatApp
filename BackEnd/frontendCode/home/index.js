...
createGroupButton.addEventListener('click',async(e)=>
{
    try{
        ...
        const groupData= await fetch(`http://13.126.61.40:3000/group/creategroup`,     
        {
            method:'post',
            credential:'include',
            headers:{
...
sendButton.addEventListener('click',async(e)=>
{
    try{
        ...
        // Showing single message on screen
         ...
         await fetch(`http://13.126.61.40:3000/message/postmessage`,     
        {
            method:'post',
            credential:'include',
            headers:{
...
function getOlderMessage()
{
    ...
    try{
        ...
        const firstId=array.length>0?array[0].id:lastId
            e.preventDefault();
            const oldMessages=  await fetch(`http://13.126.61.40:3000/message/oldmessages?id=${firstId}`,
            {method:'get',
            credential:'include',
            headers:{
            'Content-Type': 'application/json;charset=utf-8',
...
admin.addEventListener('click',async(e)=>
{
    try{
           ...
           const getAdminName=await fetch('http://13.126.61.40:3000/group/getadmin',
           {
            method:'get',
            credential:'include',
            headers:{
...
function inviteUserInGroupFunction(){
    try{
        ...
        inviteUserInGroup.addEventListener('click',async(e)=>
        {
            ...
            const invitedUserData=await fetch(`http://13.126.61.40:3000/group/adduseringroup`,     
            {
                method:'post',
                credential:'include',
                headers:{
...
userInfo.addEventListener('click',async(e)=>
{
    try{
           ...
           const userInfoData=await fetch('http://13.126.61.40:3000/home/getusers',
           {
            method:'get',
            credential:'include',
            headers:{
